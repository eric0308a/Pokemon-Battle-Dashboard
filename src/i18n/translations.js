...
const localeMessages = {
	'zh-TW': {
		...
		speedTieTag: '同速隨機',
		megaTag: 'Mega',
		megaToggleLabel: '觸發 Mega 進化',
		megaFormLabel: 'Mega 形態',
		megaOneLimitHint: '每一側同時只能有一隻寶可夢 Mega，已自動取消先前 Mega。',
		megaNotAvailable: '此寶可夢沒有可用的 Mega 形態。',
		megaLoadFailed: 'Mega 資料載入失敗，已回復原形態。',
	...
	'en-US': {
		...
		megaTag: 'Mega',
		megaToggleLabel: 'Activate Mega Evolution',
		megaFormLabel: 'Mega Form',
		megaOneLimitHint: 'Only one Mega is allowed per side. Previous Mega was reverted automatically.',
		megaNotAvailable: 'This Pokemon has no available Mega form.',
		megaLoadFailed: 'Failed to load Mega data. Reverted to base form.',
